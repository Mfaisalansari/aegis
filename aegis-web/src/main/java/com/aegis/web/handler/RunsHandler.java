...
import com.aegis.web.view.RunListView;
...
/** {@code GET /runs} — every submitted mission this session, plus summary stat tiles. */
public final class RunsHandler implements HttpHandler {

    private final MissionJobStore jobStore;

    public RunsHandler(MissionJobStore jobStore) {
    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        HandlerSupport.sendHtml(exchange, 200, RunListView.render(jobs, stats));
    }
}
